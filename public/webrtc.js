var localVideoElem = null, remoteVideoElem = null, localVideoStream = null,
    ...
    peerConn = null, wsc = new WebSocket('wss://qandanswer.herokuapp.com'),
...
function onAddStreamHandler(evt) {
  ...
  if(getParameterByName("audiooutputid") !== null){
    remoteVideo.setSinkId(getParameterByName("audiooutputid"));
  }
};
